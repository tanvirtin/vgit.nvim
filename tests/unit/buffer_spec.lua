...
describe('current', function()
    ...
    it('should call nvim_get_current_buf to retrieve the current buffer', function()
        eq(buffer.current(), 5)
...
describe('is_valid', function()
    ...
    it('should call nvim_buf_is_valid and nvim_buf_is_loaded with correct arguments', function()
...
describe('get_lines', function()
    ...
    it('should call nvim_buf_get_lines with specified start and end with correct arguments', function()
...
describe('set_lines', function()
    ...
    it('should call nvim_buf_set_lines and nvim_buf_get_option with correct arguments', function()
        api.nvim_buf_get_option.returns(true)
        buffer.set_lines(29, { 'foo', 'bar' })
        assert.stub(api.nvim_buf_set_lines).was_called_with(29, 0, -1, false, { 'foo', 'bar' })
        assert.stub(api.nvim_buf_get_option).was_called_with(29, 'modifiable')
        assert.stub(api.nvim_buf_set_option).was_not_called_with(29, 'modifiable', false)
    end)

    it('should call nvim_buf_set_lines, nvim_buf_get_option and nvim_buf_set_option with correct arguments', function()
