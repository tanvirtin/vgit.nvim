...
a.describe('navigation:', function()
  ...
  a.describe('hunk_up', function()
    ...
    a.it('should select the second last hunk if the cursor is inside the last hunk', function()
    ...
    a.it('should jump to the top of the hunk if the cursor is in the middle of the hunk', function()
      local selected = 2
    ...
    a.it('should jump to the top of the hunk if the cursor is in the end of the hunk', function()
      local selected = 2
      local hunk = hunks[selected]
    ...
    a.it('should jump to the end of the previous hunk if the cursor is in the top of the current hunk', function()
      local selected = 2
      local hunk = hunks[selected]
      vim.api.nvim_win_get_cursor = mock(vim.api.nvim_win_get_cursor, true)
  ...
  a.describe('hunk_down', function()
    a.it('should select the first hunk when the cursor on the end of last hunk', function()
      local hunk = hunks[#hunks]
      vim.api.nvim_win_get_cursor = mock(vim.api.nvim_win_get_cursor, true)
      vim.api.nvim_win_get_cursor.returns({ hunk.bot, 0 })
      eq(navigation.hunk_down(window, hunks), 1)
    end)
    a.it('should select the second hunk if the user is on the end of the first hunk', function()
      vim.api.nvim_win_get_cursor = mock(vim.api.nvim_win_get_cursor, true)
      vim.api.nvim_win_get_cursor.returns({ hunks[2].top, 0 })
      eq(navigation.hunk_down(window, hunks), 2)
    end)
    a.it('should jump to the end of the hunk if the cursor is in the middle of the hunk', function()
      local selected = 1
      local hunk = hunks[selected]
    ...
    a.it('should jump to the end of the hunk if the cursor is on top of the hunk', function()
      local selected = 1
      local hunk = hunks[selected]
      vim.api.nvim_win_get_cursor = mock(vim.api.nvim_win_get_cursor, true)
      vim.api.nvim_win_get_cursor.returns({ hunk.top, 0 })
