...
async.describe('git_conflict:', function()
  local repo
  ...
  async.describe('parse()', function()
    async.it('should parse simple conflict with current and incoming', function()
    ...
    async.it('should parse conflict with ancestor (3-way merge)', function()
      local conflicts = git_conflict.parse({
        '<<<<<<< HEAD',
        'local foo = 1',
        'print(foo)',
    ...
    async.it('should parse multiple conflicts in same file', function()
      local conflicts = git_conflict.parse({
        'line 1',
        '<<<<<<< HEAD',
        'conflict 1 current',
    ...
    async.it('should parse conflict with empty current section', function()
      local conflicts = git_conflict.parse({
        '<<<<<<< HEAD',
        '=======',
        'incoming content',
    ...
    async.it('should parse conflict with empty incoming section', function()
      local conflicts = git_conflict.parse({
        '<<<<<<< HEAD',
        'current content',
        '=======',
    ...
    async.it('should parse conflict with multiline sections', function()
      local conflicts = git_conflict.parse({
        '<<<<<<< HEAD',
        'line 1',
        'line 2',
    ...
    async.it('should return empty array for file without conflicts', function()
      local conflicts = git_conflict.parse({
        'line 1',
        'line 2',
        'line 3',
    ...
    async.it('should handle incomplete conflict markers', function()
      local conflicts = git_conflict.parse({
        '<<<<<<< HEAD',
        'current',
        '=======',
    ...
    async.it('should handle conflict markers in strings (not actual conflicts)', function()
      local conflicts = git_conflict.parse({
        'normal line',
        'another line',
      })
    ...
    async.it('should parse conflict with long branch names', function()
      local conflicts = git_conflict.parse({
        '<<<<<<< HEAD',
        'current',
        '=======',
    ...
    async.it('should handle mixed conflict types', function()
      local conflicts = git_conflict.parse({
        '<<<<<<< HEAD',
  ...
  async.describe('status()', function()
    async.it('should return nil for normal state', function()
    ...
    async.it('should detect MERGE state from git directory', function()
    ...
    async.it('should return CHERRY-PICK during cherry-pick conflict', function()
      -- Create commits
      test_repo.create_commit(repo, {
  ...
  async.describe('has_conflict()', function()
    async.it('should return false for file without conflict', function()
    ...
    async.it('should detect conflict state for files', function()
    ...
    async.it('should return false for non-conflicted file during merge', function()
  ...
  async.describe('integration scenarios', function()
    async.it('should work with conflict detection workflow', function()
    ...
    async.it('should handle normal operations without conflicts', function()
