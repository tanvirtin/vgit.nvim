...
async.describe('git_repo:', function()
  local repo
  ...
  async.describe('discover()', function()
    async.it('should discover repo from directory', function()
    ...
    async.it('should discover repo from file path', function()
    ...
    async.it('should discover repo from subdirectory file', function()
    ...
    async.it('should discover from cwd when filepath is nil', function()
    ...
    async.it('should error on non-existent path', function()
  ...
  async.describe('dirname()', function()
    async.it('should return .git directory path', function()
  ...
  async.describe('exists()', function()
    async.it('should return true for repo directory', function()
      local exists = git_repo.exists(repo)

      eq(exists, true)
    end)

    async.it('should return true for file in repo', function()
      local filepath = repo .. '/file1.txt'
    ...
    async.it('should return true for subdirectory in repo', function()
    ...
    async.it('should return false for non-repo path', function()
      local exists = git_repo.exists('/nonexistent/path/that/does/not/exist')

      eq(exists, false)
    end)

    async.it('should use cwd when filepath is nil', function()
  ...
  async.describe('config()', function()
    async.it('should retrieve repository config', function()
    ...
    async.it('should include core config values', function()
      local config, err = git_repo.config(repo)
  ...
  async.describe('has()', function()
    async.it('should return true for tracked file at HEAD', function()
    ...
    async.it('should return true when commit is nil (defaults to HEAD)', function()
    ...
    async.it('should return false for untracked file', function()
    ...
    async.it('should return false for nonexistent file', function()
    ...
    async.it('should work with files in subdirectories', function()
      test_repo.write_file(repo .. '/subdir/nested.txt', { 'nested' })
  ...
  async.describe('ignores()', function()
    async.it('should return false for non-ignored file', function()
    ...
    async.it('should return true for ignored file', function()
    ...
    async.it('should return true for ignored directory', function()
    ...
    async.it('should handle wildcard patterns', function()
    ...
    async.it('should return false when no .gitignore exists', function()
  ...
  async.describe('checkout()', function()
    async.it('should checkout branch', function()
    ...
    async.it('should checkout commit by hash', function()
    ...
    async.it('should checkout existing branch', function()
    ...
    async.it('should error when name is missing', function()
    ...
    async.it('should error on nonexistent branch', function()
  ...
  async.describe('reset()', function()
    async.it('should reset modified file', function()
    ...
    async.it('should reset all files when filename is nil', function()
    ...
    async.it('should remove untracked files', function()
    ...
    async.it('should reset specific file only', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified 1' })
      test_repo.modify_file(repo, 'file2.txt', { 'modified 2' })
    ...
    async.it('should handle subdirectory files', function()
  ...
  async.describe('clean()', function()
    ...
    async.it('should remove untracked directories', function()
    ...
    async.it('should clean specific file', function()
    ...
    async.it('should not remove tracked files', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
    ...
    async.it('should not remove staged files', function()
  ...
  async.describe('integration scenarios', function()
    async.it('should handle reset after modifications', function()
    ...
    async.it('should handle clean after adding untracked files', function()
    ...
    async.it('should verify file tracked status', function()
