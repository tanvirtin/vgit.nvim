...
async.describe('git_show:', function()
  local repo
  ...
  async.describe('lines()', function()
    async.it('should retrieve file at HEAD', function()
    ...
    async.it('should retrieve file at specific commit', function()
    ...
    async.it('should default to empty string commit when nil', function()
    ...
    async.it('should handle empty files', function()
    ...
    async.it('should handle single-line files', function()
    ...
    async.it('should handle files with empty lines', function()
    ...
    async.it('should handle files with special characters', function()
    ...
    async.it('should handle files with Unicode', function()
    ...
    async.it('should handle files in subdirectories', function()
    ...
    async.it('should handle deeply nested files', function()
    ...
    async.it('should retrieve file at old commit', function()
      local commits = {}
    ...
    async.it('should handle deleted files at current HEAD', function()
    ...
    async.it('should retrieve deleted files at old commit', function()
      local first_commit = test_repo.get_head_commit(repo)
    ...
    async.it('should handle files with very long lines', function()
    ...
    async.it('should handle files with many lines', function()
      local many_lines = {}
      for i = 1, 1000 do
        many_lines[i] = 'line ' .. i
      end
    ...
    async.it('should handle files with tabs', function()
    ...
    async.it('should handle renamed files', function()
      local first_commit = test_repo.get_head_commit(repo)
    ...
    async.it('should error on invalid commit', function()
    ...
    async.it('should handle commit with empty string', function()
    ...
    async.it('should work with short commit hashes', function()
    ...
    async.it('should handle files added in middle of history', function()
    ...
    async.it('should handle relative commit refs', function()
      test_repo.create_commit(repo, {
    ...
    async.it('should preserve line ending differences', function()
