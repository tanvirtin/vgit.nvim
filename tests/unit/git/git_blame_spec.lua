...
async.describe('git_blame:', function()
  local repo
  ...
  async.describe('list()', function()
    async.it('should return blame for entire file', function()
    ...
    async.it('should parse blame info correctly', function()
      local blames, err = git_blame.list(repo, 'file1.txt')
    ...
    async.it('should handle multi-author files', function()
    ...
    async.it('should work with specific commit', function()
    ...
    async.it('should handle files with merge commits', function()
      -- Create a branch
    ...
    async.it('should assign correct line numbers', function()
      local blames, err = git_blame.list(repo, 'file1.txt')
    ...
    async.it('should default to HEAD when commit is nil', function()
    ...
    async.it('should parse timestamps as numbers', function()
      local blames, err = git_blame.list(repo, 'file1.txt')
  ...
  async.describe('get()', function()
    async.it('should return blame for specific line', function()
    ...
    async.it('should work for first line', function()
    ...
    async.it('should work for last line', function()
    ...
    async.it('should handle different line numbers', function()
    ...
    async.it('should error on invalid line number (too high)', function()
    ...
    async.it('should error on invalid line number (zero)', function()
    ...
    async.it('should error on invalid line number (negative)', function()
      local blame, err = git_blame.get(repo, 'file1.txt', -1)
    ...
    async.it('should error when lnum is missing', function()
