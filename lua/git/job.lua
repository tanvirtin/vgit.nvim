-- Referenced from - https://github.com/nvim-lua/plenary.nvim/blob/master/lua/plenary/job.lua
...
function Job:new(o)
    ...
    obj.enable_handlers = if_nil(o.enable_handlers, true, o.enable_handlers)

    obj.enable_recording = if_nil(
        if_nil(o.enable_recording, o.enable_handlers, o.enable_recording),
        true,
        o.enable_recording
    )
