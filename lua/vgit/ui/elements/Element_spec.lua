...
describe('Element:', function()
  ...
  describe('cursor operations', function()
    ...
    it('should reset cursor to {1, 0}', function()
      local el = create_element()
      el:mount()
      el:set_lines({ 'line1', 'line2' })
      el:set_cursor({ 2, 0 })
  ...
  describe('get_buffer and get_window', function()
    it('should return valid Buffer after mount', function()
      local el = create_element()
      el:mount()
      local buf = el:get_buffer()
      assert.is_not_nil(buf)
      assert.is_true(vim.api.nvim_buf_is_valid(buf.bufnr))
    end)

    it('should return valid Window after mount', function()
      local el = create_element()
      el:mount()
      local win = el:get_window()
      assert.is_not_nil(win)
      assert.is_true(vim.api.nvim_win_is_valid(win.win_id))
    end)

    it('should return nil for buffer before mount', function()
      local el = create_element()
      assert.is_nil(el:get_buffer())
    end)

    it('should return nil for window before mount', function()
      local el = create_element()
      assert.is_nil(el:get_window())
    end)
  end)
  ...
  describe('guards when not valid', function()
    ...
    it('should return self for scroll_to', function()
      local el = create_element()
