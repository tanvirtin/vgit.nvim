...
describe('Element:', function()
  ...
  describe('constructor', function()
    ...
    it('should start unmounted', function()
      local el = create_element()
      assert.is_false(el.mounted)
    end)

    it('should have nil buffer and window before mount', function()
      local el = create_element()
      assert.is_nil(el.buffer)
      assert.is_nil(el.window)
    end)
  ...
  describe('mount', function()
    it('should set mounted to true', function()
      local el = create_element()
      el:mount()
      assert.is_true(el.mounted)
    end)

    it('should create buffer and window', function()
      local el = create_element()
      el:mount()
      assert.is_not_nil(el.buffer)
      assert.is_not_nil(el.window)
    end)
    ...
    it('should be idempotent', function()
      ...
      local win = el.window
      el:mount()
      assert.are.equal(buf, el.buffer)
      assert.are.equal(win, el.window)
    end)
  ...
  describe('window options', function()
    it('should update window options', function()
      ...
      assert.is_true(el.config.win_options.wrap)
    end)
