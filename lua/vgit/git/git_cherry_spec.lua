...
describe('git_cherry', function()
  ...
  describe('pick', function()
    it('should cherry-pick a commit', function()
      ...
      assert.equals('cherry content', content[1], 'File content should match')
    ...
    it('should cherry-pick multiple commits', function()
      ...
      assert.equals('commit 1', content1[1], 'File1 content should match')

      local content2 = fs.read_file(repo:get_path() .. '/c2.txt')
      assert.equals('commit 2', content2[1], 'File2 content should match')
