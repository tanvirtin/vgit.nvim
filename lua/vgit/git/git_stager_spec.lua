...
describe('git_stager:', function()
  ...
  describe('stage()', function()
    it('should stage single modified file', function()
    ...
    it('should stage single new file', function()
    ...
    it('should stage single deleted file', function()
    ...
    it('should stage all files with "."', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
    ...
    it('should default to "." when filename is nil', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
    ...
    it('should stage files in subdirectories', function()
    ...
    it('should handle staging already staged file', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
  ...
  describe('unstage()', function()
    it('should unstage single file', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
      git_stager.stage(repo, 'file1.txt')
    ...
    it('should unstage all files with "."', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
      test_repo.modify_file(repo, 'file2.txt', { 'also modified' })
    ...
    it('should unstage partially and leave working tree changes', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
      git_stager.stage(repo, 'file1.txt')
    ...
    it('should unstage new files', function()
      test_repo.write_file(repo .. '/new.txt', { 'new' })
    ...
    it('should unstage deleted files', function()
  ...
  describe('stage_hunk()', function()
    ...
    it('should stage change-type hunk', function()
    ...
    it('should stage remove-type hunk', function()
    ...
    it('should handle complex hunks', function()
    ...
    it('should error when hunk is missing', function()
  ...
  describe('unstage_hunk()', function()
    ...
    it('should unstage specific hunk when multiple exist', function()
      test_repo.modify_file(repo, 'file1.txt', {
        'changed line 1',
        'line 2',
        'changed line 3',
