...
describe('git_status:', function()
  ...
  describe('ls()', function()
    it('returns empty list for clean working tree', function()
    ...
    it('detects modified file (unstaged)', function()
    ...
    it('detects modified file (staged)', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
    ...
    it('detects untracked file', function()
    ...
    it('returns single file when filename specified', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
    ...
    it('returns error when reponame is missing', function()
  ...
  describe('tree()', function()
    ...
    it('detects file additions', function()
      local initial = test_repo.get_head_commit(repo, false)
    ...
    it('detects file deletions', function()
      local initial = test_repo.get_head_commit(repo, false)
