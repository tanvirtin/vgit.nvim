...
describe('git_log:', function()
  ...
  describe('get()', function()
    it('should retrieve single commit by hash', function()
    ...
    it('should retrieve commit by HEAD', function()
    ...
    it('should handle initial commit with no parent', function()
      local commit_hash = test_repo.get_head_commit(repo)
    ...
    it('should parse author name with spaces', function()
      test_repo.create_commit(repo, {
    ...
    it('should error on invalid commit hash', function()
    ...
    it('should error when commit is missing', function()
  ...
  describe('list()', function()
    ...
    it('should return logs in reverse chronological order', function()
      local commits = {}
      for i = 2, 5 do
        test_repo.create_commit(repo, {
          files = { ['file' .. i .. '.txt'] = { 'content ' .. i } },
    ...
    it('should work without pagination', function()
      test_repo.create_commit(repo, {
        files = { ['file2.txt'] = { 'content' } },
        message = 'Second commit',
      })
    ...
    it('should work with nil opts', function()
    ...
    it('should handle commits with Unicode in author name', function()
      test_repo.create_commit(repo, {
        files = { ['file2.txt'] = { 'content' } },
        message = 'Test commit',
    ...
    it('should handle commits with Unicode in message', function()
      test_repo.create_commit(repo, {
        files = { ['file2.txt'] = { 'content' } },
        message = 'Fix: 🐛 bug',
      })
