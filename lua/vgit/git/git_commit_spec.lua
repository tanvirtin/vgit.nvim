...
describe('git_commit:', function()
  ...
  describe('create()', function()
    it('should create commit with message', function()
    ...
    it('should create commit with simple message', function()
    ...
    it('should handle Unicode in message', function()
      test_repo.modify_file(repo, 'file1.txt', { 'changed' })
      test_repo.stage(repo, '.')
    ...
    it('should commit multiple files', function()
    ...
    it('should commit only staged changes', function()
    ...
    it('should error on no staged changes', function()
    ...
    it('should error on clean working tree', function()
    ...
    it('should error when description is missing', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
      test_repo.stage(repo, '.')
    ...
    it('should create commit with deleted file', function()
    ...
    it('should create commit with renamed file', function()
    ...
    it('should create commit after staging directory', function()
    ...
    it('should handle message with single quotes', function()
      test_repo.modify_file(repo, 'file1.txt', { 'changed' })
      test_repo.stage(repo, '.')
    ...
    it('should handle message with newlines', function()
      test_repo.modify_file(repo, 'file1.txt', { 'changed' })
      test_repo.stage(repo, '.')
    ...
    it('should handle message with tabs', function()
      test_repo.modify_file(repo, 'file1.txt', { 'changed' })
      test_repo.stage(repo, '.')
  ...
  describe('dry_run()', function()
    it('should show what would be committed', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
      test_repo.stage(repo, 'file1.txt')
    ...
    it('should not create actual commit', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
      test_repo.stage(repo, 'file1.txt')
    ...
    it('should show status with staged files', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
    ...
    it('should work with multiple staged files', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
    ...
    it('should handle partially staged files', function()
  ...
  describe('integration scenarios', function()
    it('should handle dry_run then commit workflow', function()
      test_repo.modify_file(repo, 'file1.txt', { 'modified' })
      test_repo.stage(repo, '.')
