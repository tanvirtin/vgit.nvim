...
describe('git_bisect:', function()
  ...
  describe('start()', function()
    it('should start bisect session with good and bad commits', function()
    ...
    it('should start bisect without commits', function()
      local result, err = git_bisect.start(repo)
    ...
    it('should support no-checkout option', function()
      local good_commit = test_repo.get_head_commit(repo)
    ...
    it('should support first-parent option', function()
      local good_commit = test_repo.get_head_commit(repo)
    ...
    it('should support single good commit', function()
      local good_commit = test_repo.get_head_commit(repo)
    ...
    it('should support multiple good commits', function()
      local commits = {}
      for i = 1, 3 do
        test_repo.create_commit(repo, {
    ...
    it('should support path limiters', function()
      local good_commit = test_repo.get_head_commit(repo)
    ...
    it('should support multiple path limiters', function()
      local good_commit = test_repo.get_head_commit(repo)
    ...
    it('should error when marking invalid commits', function()
      local good_commit = test_repo.get_head_commit(repo)
  ...
  describe('bad()', function()
    it('should mark current commit as bad', function()
      local good_commit = test_repo.get_head_commit(repo)
    ...
    it('should mark specific commit as bad', function()
      local commits = {}
      for i = 1, 5 do
        test_repo.create_commit(repo, {
          files = { ['file' .. i .. '.txt'] = { 'content' } },
    ...
    it('should error when bisect not started', function()
      local result, err = git_bisect.bad(repo)
    ...
    it('should handle invalid commit hash', function()
      local good_commit = test_repo.get_head_commit(repo)
  ...
  describe('good()', function()
    it('should mark current commit as good', function()
      local good_commit = test_repo.get_head_commit(repo)
    ...
    it('should mark specific commit as good', function()
      local commits = {}
      for i = 1, 5 do
        test_repo.create_commit(repo, {
          files = { ['file' .. i .. '.txt'] = { 'content' } },
    ...
    it('should mark multiple commits as good', function()
      local commits = {}
      for i = 1, 5 do
        test_repo.create_commit(repo, {
          files = { ['file' .. i .. '.txt'] = { 'content' } },
  ...
  describe('in_progress()', function()
    it('should return false when no bisect in progress', function()
      local in_progress = git_bisect.in_progress(repo)
  ...
  describe('status()', function()
    it('should return not in progress when no bisect active', function()
  ...
  describe('terms()', function()
    it('should allow custom terms', function()
      local good_commit = test_repo.get_head_commit(repo)
    ...
    it('should error when term is missing', function()
  ...
  describe('integration workflows', function()
    it('should complete full bisect workflow', function()
      local commits = {}
      for i = 1, 5 do
        test_repo.create_commit(repo, {
    ...
    it('should handle bisect with path limiters', function()
      test_repo.create_commit(repo, {
        files = { ['file1.txt'] = { 'v1' } },
        message = 'File1 v1',
      })
